...
Portanto, esse aplicativo implementa as funcionalidades de um sistema CRUD, permitindo aos usuários criar, ler, atualizar e excluir pedidos de burger de forma eficiente e intuitiva.

## EXECUTANDO O PROJETO:
1. **Instalando as Dependências:**
   - Para instalar as dependências listadas no arquivo "package.json", utilize o comando `npm install`. Certifique-se de estar no diretório do seu projeto onde o arquivo "package.json" está localizado. O npm lerá o arquivo "package.json" e instalará todas as dependências listadas nele. 

   - Eis o comando completo:
